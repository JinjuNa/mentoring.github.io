  ...
  <div class="sub">
    ...
    <div class="recruit">
      <div class="contents">
        ...
        <!-- p태그 클래스명 par -> far으로 바꿔야하나? -->
        절대로 현재에 머무르려고 하지 않는다고 믿습니다.</p>
        <p class="par">그래서 저희 회사에는 없는 것이 다음과 같습니다.</p>
      </div>
      ...
      <div class="icon">
        <ul class="subicon">
          <li class="char1">
            <img>
            <h2>직급이 없습니다.</h2>
            <p>동등한 관계에서만 좋은 아이디어가 나온다고 믿기 때문입니다.<br>
          ...
          <li class="char1">
            <img>
            <h2>야근이 없습니다.</h2>
            <p>모든 직원이 재택근무를 하기 때문에 야근이 없습니다.<br>
        ...
        <ul class="subicon">
          ...
          <li class="char2">
            <img>
            <h2>경력직이 없습니다.</h2>
            <p>모든 직원은 3년 안에 독립(창업)하는 것을 목표로 합니다.<br>
